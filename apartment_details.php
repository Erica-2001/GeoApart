...
<div class="location">
  <strong><a href="tenant_live_directions.php?id=<?= $apartment_id ?>" style="color: inherit; text-decoration: none;">
...
<a href="available_units.php?apartment_id=<?= $apartment_id ?>" class="btn btn-units"><i class="fas fa-door-open"></i> Check Available Units</a>
    ...
    <i class="fas fa-sms"></i> Contact Landlord
  </a>
