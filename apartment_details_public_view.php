...
// Mark as viewed using localStorage (client-side)
...
<body>
  ...
  <div class="location">
    <strong><a href="live_directions.php?id=<?= $apartment_id ?>" style="color: inherit; text-decoration: none;" onclick="markAsViewed(<?= $apartment_id ?>)">
