...
<main class="container">
    ...
    <section class="apartment-list" id="apartmentList">
        <?php while ($apartment = mysqli_fetch_assoc($apartments)): ?>
            ...
            ?>
            <a href="apartment_details_public.php?id=<?php echo $apartment['id']; ?>" class="apartment-link">
                <div class="apartment-card"
                     data-type="<?php echo strtolower($apartment['apartment_type']); ?>"
                     data-price="<?php echo $apartment['price']; ?>">

                    <!-- Apartment Image -->
                    <div class="img-placeholder">
                        <img src="<?php echo $displayImage; ?>" alt="Apartment">
                    </div>
                    ...
                    <div class="apartment-info">
                        ...
                        <p class="landlord-info"><i class="fas fa-home"></i> Type: <?php echo htmlspecialchars($apartment['apartment_type']); ?></p>
                        <p class="landlord-info"><i class="fas fa-user"></i> Landlord: <?php echo htmlspecialchars($apartment['landlord_name']); ?></p>
                        <p class="landlord-info"><i class="fas fa-envelope"></i> Email: <?php echo htmlspecialchars($apartment['landlord_email']); ?></p>
                        <p class="landlord-info"><i class="fas fa-phone"></i> Contact Number: <?php echo htmlspecialchars($apartment['landlord_mobile']); ?></p>
                    </div>
                </div>
            </a>
        <?php endwhile; ?>
