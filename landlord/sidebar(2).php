...
<script>
  ...
  // Force initial collapse on load
  ...
  function toggleSidebar() {
    ...
    profile.style.display = isCollapsed ? "none" : "flex";
    search.style.display = isCollapsed ? "none" : "flex";
    links.style.display = isCollapsed ? "none" : "block";
  }
</script>
