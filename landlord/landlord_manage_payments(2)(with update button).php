...
<div id="proofModal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background-color:rgba(0,0,0,0.7); z-index:9999;">
  <div style="background:#fff; margin:5% auto; padding:20px; max-width:600px; border-radius:10px; position:relative;">
    ...
    <img id="proofImage" src="" alt="Proof of Payment" style="max-width:100%; height:auto; border-radius:10px;">
  </div>
</div>
