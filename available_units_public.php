...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        body { background: #f4f4f4; color: #333; padding: 20px; text-align: left; }
        .container { max-width: 1100px; margin: auto; background: white; padding: 20px; border-radius: 8px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1); text-align: left; }
...
<div class="back">
  <a href="apartment_details_public.php?id=<?php echo $apartment_id; ?>" class="back-btn" title="Go back to apartment details">
    ...
    <div class="unit-list">
        <?php while ($unit = mysqli_fetch_assoc($result)): ?>
            <?php
                ...
                if (empty($images)) {
                    $images[] = "uploads/default_unit.jpg";
                }
            ?>
            ...
            <div class="unit-card">
                ...
                <div class="unit-info">
                    ...
                    <p><strong>Features:</strong> <?php echo nl2br(htmlspecialchars($unit['unit_features'])); ?></p>
                </div>
