        ...
        <?php while ($unit = mysqli_fetch_assoc($result)): ?>
            ...
            <div class="unit-card">
                ...
                <div class="landlord-info">
                    ...
                    <a href="https://www.google.com/maps/search/?api=1&query=<?php echo urlencode($apartment['location']); ?>" target="_blank" class="btn btn-map"><i class="fas fa-map"></i> View on Map</a>
